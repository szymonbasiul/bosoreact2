...
const RPS_gui = function () {
  ...
  obj[key];
	...
	const game = (<div className="rpsShape">
		<div id="rps" onClick={() => {  }} className="rpsActionButton Up"><img src={require("../../../img/stone.jpg").default} alt="stone" /></div>
	<div id="rps" onClick={() => {  }} className="rpsActionButton Mid"><img src={require("../../../img/paper.png").default} alt="paper" /></div>
	<div id="rps" onClick={() => {  }} className="rpsActionButton Down"><img src={require("../../../img/scissors.jpg").default} alt="scissors" /></div>
	...
	const introScreen = (
		...
		<div className="intro">Witaj w Naszej grze!</div>
			<button onClick={() => { setStageState("RPS") }} >Przejdź do rozgrywki</button>
			</div>
	)
