...
const Calculator_gui = function () {
  const [actionDisplayValue, setActionDisplayValue] =
  ...
  const addValueToDisplay = (value: string) => {
    if (actionDisplayValue.firstSetOfNumbersForAction === "0") {
      setActionDisplayValue({
        ...actionDisplayValue,
        ...{
          firstSetOfNumbersForAction:
            (actionDisplayValue.firstSetOfNumbersForAction = value),
        },
      });
    } else if (
      actionDisplayValue.activeArithmeticSign === " " &&
      actionDisplayValue.firstSetOfNumbersForAction !== "0"
    ) {
      setActionDisplayValue({
        ...actionDisplayValue,
        ...{
      ...
      setActionDisplayValue({
        ...
        ...{
          secondSetOfNumbersForAction:
            actionDisplayValue.secondSetOfNumbersForAction + value,
        },
      });
    }
  };
  ...
  const asignArithmeticSignToStateValue = (sign: string) => {
    setActionDisplayValue({
      ...actionDisplayValue,
      ...{
        activeArithmeticSign: (actionDisplayValue.activeArithmeticSign = sign),
      },
    });
  };
  ...
  const undoLastAction = () => {
    if (
      actionDisplayValue.activeArithmeticSign === " " &&
      actionDisplayValue.resultForAction === 0
    ) {
      setActionDisplayValue({
        ...actionDisplayValue,
        ...{
          firstSetOfNumbersForAction:
            (actionDisplayValue.firstSetOfNumbersForAction =
              actionDisplayValue.firstSetOfNumbersForAction.substring(
                0,
                actionDisplayValue.firstSetOfNumbersForAction.length - 1
              )),
        },
      });
    } else if (
      ...
      setActionDisplayValue({
        ...
        ...{
          secondSetOfNumbersForAction:
            (actionDisplayValue.secondSetOfNumbersForAction =
              actionDisplayValue.secondSetOfNumbersForAction.substring(
                0,
                actionDisplayValue.secondSetOfNumbersForAction.length - 1
              )),
        },
      });
    }
  ...
  const asignMathOperationToResultForActionState = () => {
    setActionDisplayValue({
      ...actionDisplayValue,
      ...{
        resultForAction: (actionDisplayValue.resultForAction =
          doMathOperation()),
      },
    });
  };
  ...
  const arithmeticButtons = ButtonsObject.displayString.map((x) => {
    if (x === "=") {
      return (
        <div
          key={x}
          onClick={() => {
            asignMathOperationToResultForActionState();
          }}
          className="common-button wideButton"
        >
          {x}
        </div>
      );
      ...
      return (
        <div
          key={x}
          onClick={() => {
            asignArithmeticSignToStateValue(x);
          }}
          className="common-button"
        >
          {x}
  ...
  const numberButtons = ButtonsObject.displayNumbers.map((x) => {
    if (x === "0") {
      return (
        <div
          key={x}
